            ...
            <div class="row">
                <div class="col-12 col-xl-8 col-lg-6">
                    <div class="hero-items">
                        <div class="book-shape">
                            <img src="/img/hero/book.png" alt="shape-img">
                        </div>
                        <div class="frame-shape1 float-bob-x">
                            <img src="/img/hero/frame.png" alt="shape-img">
                        </div>
                        <div class="frame-shape2 float-bob-y">
                            <img src="/img/hero/frame-2.png" alt="shape-img">
                        </div>
                        <div class="frame-shape3">
                            <img src="/img/hero/xstar.png" alt="img">
                        </div>
                        <div class="frame-shape4 float-bob-x">
                            <img src="/img/hero/frame-shape.png" alt="img">
                        </div>
                        <div class="bg-shape1">
                            <img src="/img/hero/bg-shape.png" alt="img">
                        </div>
                        <div class="bg-shape2">
                            <img src="/img/hero/bg-shape2.png" alt="shape-img">
                        </div>
                ...
                <div class="col-12 col-xl-4 col-lg-6">
                    <div class="girl-image">
                        <img class=" float-bob-x" src="/img/hero/hero-girl.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
